...
zone_file_objects = {
  ...
  "sample_2": {
    ...
    "alias": [
        {"name": "aname", "host": "otherdomain.com", "class": "IN"}
    ],
    "mx": [
    ...
    "srv": [
        {"name": "_xmpp-client._tcp", "class": "IN", "target": "jabber", "priority": 10,
         "weight": 0, "port": 5222},
        {"name": "_xmpp-server._tcp", "class": "IN", "target": "jabber", "priority": 10,
         "weight": 0, "port": 5269}
    ]
  },
  "sample_3": {
